...
var olsAutocompleteModule = function(){
    var olsAutocomplete = function(){
    ...
    return olsAutocomplete;
};

    angular.module('olsAutocompleteMod',[]).
	factory('olsAutocomplete',[olsAutocompleteModule]);
})();
